...
router.get(
  "/products",
  adminProtect,
  requirePermission(AdminPermission.VIEW_PRODUCTS),
  getAllProducts,
);
router.get(
...
router.post(
  "/products",
  adminProtect,
  requirePermission(AdminPermission.CREATE_PRODUCT),
...
router.put(
  "/products/:id",
  adminProtect,
  requirePermission(AdminPermission.UPDATE_PRODUCT),
...
router.delete(
  "/products/:id",
  adminProtect,
  requirePermission(AdminPermission.DELETE_PRODUCT),
  deleteProduct,
);
...
router.get(
  "/orders",
  adminProtect,
  requirePermission(AdminPermission.VIEW_ORDERS),
  getAllOrders,
);
router.get(
  "/orders/:id",
...
router.patch(
  "/orders/:id/status",
  adminProtect,
  requirePermission(AdminPermission.UPDATE_ORDER),
  updateOrderStatus,
);
router.patch(
  "/orders/:id/payment",
